...
if __name__ == '__main__':
    ...
    query_strings = [query_string[0] for query_string in conn.query(orm_egauge.SensorInfo.query_string).filter_by(sensor_type=orm_egauge.SensorType.egauge, is_active=True).distinct()]
