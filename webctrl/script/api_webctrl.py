...
if __name__ == '__main__':
    ...
    conn = get_db_handler()
    sensors = conn.query(orm_webctrl.SensorInfo.purpose_id, orm_webctrl.SensorInfo.sensor_id, orm_webctrl.SensorInfo.last_updated_datetime, orm_webctrl.SensorInfo.unit).filter_by(sensor_type=orm_webctrl.SensorType.webctrl, is_active=True)
